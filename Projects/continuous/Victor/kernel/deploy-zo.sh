...
EMBEDDING_PROVIDER="${EMBEDDING_PROVIDER:-local-transformers}"
LOCAL_EMBEDDING_MODEL="${LOCAL_EMBEDDING_MODEL:-Xenova/all-MiniLM-L6-v2}"
LOCAL_EMBEDDING_DIMENSIONS="${LOCAL_EMBEDDING_DIMENSIONS:-384}"
LOCAL_EMBEDDING_CACHE_DIR="${LOCAL_EMBEDDING_CACHE_DIR:-}"
OPENAI_BASE_URL="${OPENAI_BASE_URL:-https://api.openai.com/v1}"
OPENAI_EMBEDDING_MODEL="${OPENAI_EMBEDDING_MODEL:-text-embedding-3-small}"
OPENAI_EMBEDDING_DIMENSIONS="${OPENAI_EMBEDDING_DIMENSIONS:-1536}"
WORKDIR="$(pwd)"

EMBEDDINGS_STATUS="$EMBEDDING_PROVIDER"
...
echo "Vector retrieval defaults to a local transformers embedding model"
