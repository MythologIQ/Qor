...
### 1. Forecast and Planning Operations
...
- [ ] Forecast remaining Builder delivery work depends on Victor promotion review packet
  - Depends On: Forecast and Planning Operations dependency review for Victor promotion review packet
  - Acceptance: Builder forecast work is grounded in the reviewed Victor promotion state.

- [ ] Project Victor autonomy dependency impact into Builder surfaces depends on Project Victor autonomy dependency impact dependency anchor
  - Depends On: Project Victor autonomy dependency impact dependency anchor
  - Acceptance: The Builder dependency task has a directly retrievable dependency anchor instead of implied context.

- [ ] Project Victor autonomy dependency impact into Builder surfaces depends on verification-grade automation reporting
  - Depends On: Forecast and Planning Operations verification-grade automation reporting dependency
...
- [ ] Queue next governed slices across Victor and Builder depends on separate Builder and Victor project tracks
  - Depends On: Forecast and Planning Operations separate Builder and Victor project tracks dependency
