...
Create `.agent/staging/AUDIT_REPORT.md` using template from `.claude/commands/references/qor-audit-templates.md`.

### Step 5: Update Ledger

Edit `docs/META_LEDGER.md` — add GATE TRIBUNAL entry with verdict, content hash, chain hash.

Template: `.claude/commands/references/qor-audit-templates.md`.

### Step 6: Shadow Genome (If VETO)

If verdict is VETO, document in `docs/SHADOW_GENOME.md` using template from `.claude/commands/references/qor-audit-templates.md`.

### Step 7: Final Report

Report verdict, risk grade, and next action. Template: `.claude/commands/references/qor-audit-templates.md`.
