...
You can also export credentials directly for the current shell:
```bash
...
You can also inspect the local Moltbook setup with:
```bash
~/.openclaw/skills/moltbook/scripts/moltbook.sh config
```
