...
Isolation rules: `.claude/commands/references/qor-organize-templates.md`.
...
Archetype definitions: `.claude/commands/references/qor-organize-templates.md`.
...
Convention checks: `.claude/commands/references/qor-organize-templates.md`.
...
Proposal template: `.claude/commands/references/qor-organize-templates.md`.
...
Template: `.claude/commands/references/qor-organize-templates.md`.
...
Privacy patterns: `.claude/commands/references/qor-organize-templates.md`.
